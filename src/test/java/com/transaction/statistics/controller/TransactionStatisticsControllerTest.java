...
import com.transaction.statistics.controller.TransactionStatisticsController;
...
public class TransactionStatisticsControllerTest {
    ...
    public void shouldReturnSampleStatistics() throws Exception {
        when(statisticsService.getTransactionStatistics()).thenReturn(TransactionStatistic.builder()
                .count(3)
                .sum(43.8)
                .max(42.5)
                .min(0.3)
